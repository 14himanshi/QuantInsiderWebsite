...
const Team = () => {
  ...
  const advisoryBoard = [
    {
      ...
      role: "Advisor",
      description:
        "Founder and CEO of Real Time Risk Systems LLC. Co-founded an alternative asset management fund that expanded from $150M to $1.1B. Former head of quantitative analysis at Highbridge Capital Management and O'Connor risk group at Swiss Bank (now UBS).",
    ...
    },
    {
      ...
      role: "Advisor",
      description:
        "Co-Founder and CEO of Moontower.ai, an options analytics platform. Former trader at Susquehanna International Group (SIG). Over 20 years of institutional trading experience with memberships on AMEX, NYMEX, COMEX, ICE/NYBOT, and NYSE.",
    ...
    },
    {
      ...
      role: "Advisor",
      description:
        "Internationally acclaimed ETF Trader with 15+ years of experience on Wall Street. Held leadership positions at KCG, Goldman Sachs, and Mizuho Securities. Recognized by the U.S. Government and profiled in The New York Times as the face of a 'new breed of Wall Street trader'.",
    ...
    },
    {
      ...
      role: "Advisor",
      description:
        "Prakarsh Duhoon is a quant finance professional with 7.5+ years of experience, specializing in systematic equity and alpha research. He has worked at Millennium Management and WorldQuant, served as Director of WorldQuant BRAIN, mentors aspiring quants, and is an alumnus of UC Berkeley and IIT Roorkee with CFA Level I & II qualifications.",
  ...
  const coreTeam = [
    {
      ...
      role: "Team Member",
      description:
        "Holder of the Certificate in Quantitative Finance (CQF) with a strong foundation in both traditional and quantitative finance. A commerce graduate and CFA Level 2 cleared, his journey into quantitative finance began with the CQF.",
    ...
    },
    {
      ...
      role: "Faculty",
      description:
        "Assistant professor at Medicaps University with a PhD in mathematics from Dayalbagh Educational Institute. Specializes in Non-Manifold Topologies on Lorentz Manifolds with 50+ research papers. Has 8+ years of teaching experience and qualified for NET and GATE examinations with All India rank 40 and 90 respectively.",
  ...
  const allMembers = [...leadershipTeam, ...advisoryBoard, ...coreTeam];
    ...
    <div className="flex flex-col items-center min-h-screen pb-20">
      <div className="w-full text-center pt-24 pb-12 px-5">
        ...
        <p className="max-w-2xl mx-auto text-lg text-gray-600 font-light">
          Meet the experts, developers, and industry veterans dedicated to
          revolutionizing algorithmic trading.
        </p>
      </div>

      <div className="container mx-auto px-5 max-w-screen-2xl w-full">
